...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos remover sua instalacao...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear ${empresa_bloquear}...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear ${empresa_desbloquear}...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios ${empresa_dominio}...${GRAY_LIGHT}"
  printf "\n\n"
